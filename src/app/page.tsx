...
const content = {
  en: {
    ...
    desc3: "Final exam (mandatory) + optional assignments for up to +1.5 bonus points (1 extra point for all handout delivery and 0.5 extra points for all tutoral exercises delivery).",
    view: "View Handout",
    viewTutorial: "View Exercise",
    onThisPage: "On this page",
    prerequisite: "Prerequisites",
    handoutsLabel: "Handouts",
    tutorialsLabel: "Tutorial Exercises",
    nav: [
      { id: "intro", label: "Intro" },
      { id: "prerequisites", label: "Prerequisites" },
      { id: "handouts", label: "Handouts" },
      { id: "tutorials", label: "Tutorial Exercises" },
    ...
    handouts: [
      ...
      { label: "04 · Fourth Handout", title: "Fundamentals of Memory Management in the Linux Kernel", desc: "This assignment introduces the fundamental mechanisms of memory allocation and synchronization in the Linux kernel. It focuses on kernel-space memory management using interfaces such as kmalloc and get_free_pages, as well as synchronization mechanisms. The goal is to provide a solid understanding of low-level memory management and concurrency control within operating system kernels.", href: "/handouts/memory-management" },
    ...
    tutorials: [
      { label: "01 · Tutorial Exercise", title: "Exercise 1: Thread execution synchronization", desc: "", href: "/tutorials/tutorial_1" },
      { label: "02 · Tutorial Exercise", title: "Exercise 2: Thread execution synchronization", desc: "", href: "/tutorials/tutorial_2" },
  ...
  gr: {
    ...
    desc3: "Τελική εξέταση (υποχρεωτική) + προαιρετικές εργασίες έως +1.5 μονάδα bonus (1 επιπλέον μονάδα για παράδοση όλων των θεωρητικών δραστηριοτήτων και 0.5 επιπλέον μονάδα για παράδοση όλων των φροντιστηριακών ασκήσεων).",
